...
public class CamelCards {
    public static void main(String[] args) {
        try (InputStream inputStream = CamelCards.class.getClassLoader().getResourceAsStream("input.txt");
            ...
            while ((s = reader.readLine()) != null) {
                ...
                if (mat.matches()) {
                    hands.add(new Hand(mat.group(1), mat.group(2), false));
                } else {
    ...
    private static class Hand implements Comparable<Hand> {
        ...
        public Hand(String hand, String bid, boolean joker) {
            ...
            this.cards = cs.toArray(new Card[0]);
            this.rank = Rank.determine(cards);
        }
        ...
        @Override
        public String toString() {
            return Arrays.toString(cards) + " " + rank + " " + bid;
        }
    }
}
